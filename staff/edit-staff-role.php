...
// Enforce access check for editing staff
...
if (isset($_POST['name']) && !empty($_POST['name'])) {
    ...
    $query = "UPDATE tbl_staff_roles SET name='$name' WHERE id='$id'";
    if (mysqli_query($connection, $query)) {
        header('Location: staff-roles-list.php');
        exit;
    } else {
        $message = '<div class="alert alert-danger"><i class="fas fa-exclamation-circle mr-2"></i>Error updating designation: ' . mysqli_error($connection) . '</div>';
    }
}

// Fetch record
$sql = "SELECT * FROM tbl_staff_roles WHERE id='$id' AND deleted_at IS NULL LIMIT 1";
...
<head>
    ...
    <title>PPMS - Edit Staff Designation #<?php echo $id; ?></title>
    <style>
...
<main class="main">
    <div class="container pt-4 pb-5">
        ...
        <div class="page-header">
            <div>
                <h4><i class="fas fa-id-badge mr-2"></i>Edit Staff Designation #<?php echo $id; ?></h4>
                <small class="text-white-50">Update employee job role / title</small>
            </div>
        ...
        <form action="edit-staff-role.php?id=<?php echo $id; ?>" method="POST">
