...
<div class="container mt-4 mb-5" style="max-width: 850px;">
    <div class="page-header">
        <div>
            ...
            <small class="text-white-50">Editing settlement for Batch #<?php echo htmlspecialchars($settlement['batch_no']); ?> (<?php echo date('d-m-Y', strtotime($settlement['settlement_date'])); ?>)</small>
        </div>
    ...
    <div class="form-card">
        ...
        <form method="POST" id="editSettlementForm" class="p-4" onsubmit="return validateSettlementForm()">
            <div class="row">
                <!-- Settlement Date -->
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="settlement_date" id="settlement_date" class="form-control font-weight-bold" value="<?php echo htmlspecialchars($settlement['settlement_date']); ?>" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="card_machine_id" id="card_machine_id" class="form-control font-weight-bold" required onchange="calculateSettlement()">
                        ...
                        <?php foreach ($card_machines as $cm): ?>
                            <option value="<?php echo $cm['id']; ?>" data-fee="<?php echo floatval($cm['charges_percentage']); ?>" <?php echo ($settlement['card_machine_id'] == $cm['id']) ? 'selected' : ''; ?>>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="batch_no" id="batch_no" class="form-control font-weight-bold text-monospace" value="<?php echo htmlspecialchars($settlement['batch_no']); ?>" required>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="number" step="0.01" min="0.01" name="amount" id="amount" class="form-control form-control-lg font-weight-bold text-primary" value="<?php echo floatval($settlement['amount']); ?>" required oninput="calculateSettlement()">
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="notes" id="notes" class="form-control" rows="2"><?php echo htmlspecialchars($settlement['notes'] ?? ''); ?></textarea>
                </div>
            </div>
