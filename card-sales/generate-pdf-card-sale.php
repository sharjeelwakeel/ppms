...
if ($res) {
    while ($r = mysqli_fetch_assoc($res)) {
        ...
        $tot_diff += floatval($r['difference'] ?? 0);
...
<body>
    ...
    <div class="metric-cards">
        <div class="metric-cell">
            <div class="lbl">Total Batches / Entries</div>
            <div class="val"><?php echo count($items); ?> Entries</div>
        </div>
        <div class="metric-cell">
        ...
        <tbody>
            ...
            <?php 
                ...
                foreach ($items as $item): 
                    ...
                    $diff  = floatval($item['difference'] ?? 0);
            ...
            <tr>
                ...
                <td style="text-align: center; font-family: monospace;"><?php echo htmlspecialchars($item['trace_no'] ?: '—'); ?></td>
