		...
		<main class="main">
			<div class="container pt-4 pb-4">
				...
				<table id="productsListTable" class="table table-striped table-bordered">
					...
					<tbody>
						<?php 
						$sql = "SELECT * FROM tbl_lubricant_products ORDER BY id DESC";
							...
							while($row = mysqli_fetch_assoc($result)){
								echo' 
									<tr>
										...
										<td><a class="btn btn-large btn-link p-0 text-danger" onclick="deleteProduct('.$row['id'].')"><i class="fas fa-trash-alt" style="font-size: 20px;"></i></a></td>
									</tr>';
							}
						}
						?>
