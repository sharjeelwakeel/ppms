# Credit Sale Receivables & Customer Payments Module (`markdown/credit_sale_receivables.md`)

The **Credit Sale Receivables** module (`accounts/credit-sale-receivables.php`, `accounts/payment-history.php`) provides full credit sales billing, customer payment collection, and multi-mode financial reconciliation for PPMS.
...
│      (Filtered slips remaining due)          │           (Customer's total debt)            │
└──────────────────────────────────────────────┴──────────────────────────────────────────────┘
```
