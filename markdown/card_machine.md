# Card Machines Module Complete Documentation (`markdown/card_machine.md`)
...
| `markdown/card_machine.md` | Module specification and complete documentation (this file) |
