...
$test_date = '2029-01-08';
$test_shift = 1;
$nozzle_id = 1;

test_header('TC-CASH-08', 'Card Sale Delete Restoration on Cash Remainder');
...
try {
    ...
    // 3. User soft-deletes the Card Sale
    mysqli_query($connection, "UPDATE tbl_meter_reading_card_sales SET deleted_at = NOW() WHERE id = '$cd_id'");
...
exit(print_suite_summary('TC-CASH-08'));
