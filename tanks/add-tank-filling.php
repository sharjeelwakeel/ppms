...
$message = '';
if (isset($_POST['tank_id']) && isset($_POST['date']) && isset($_POST['last_reading']) && isset($_POST['current_reading'])) {
    ...
    $query = "INSERT INTO tbl_tank_filling (tank_id, date, last_reading, current_reading) 
              VALUES ('$tank_id', '$date', '$last_reading', '$current_reading')";
    
    if (mysqli_query($connection, $query)) {
        header('Location: tank-filling-list.php');
        exit;
    } else {
        $message = '<div class="alert alert-danger">Error saving tank filling record: ' . mysqli_error($connection) . '</div>';
    }
}
...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<title>PPMS - Add Tank Filling</title>
	</head>
	<body>
		...
		<main class="main">
			<div class="container pt-4 pb-4">
				<form action="add-tank-filling.php" method="POST">
					<h4 class="mb-5">Add Tank Filling</h4>
                    <?php echo $message; ?>
					<div class="card mb-5">
						<div class="card-body">
							<div class="row">
