...
if (isset($_POST['tank_name']) && isset($_POST['start_reading']) && isset($_POST['item_id'])) {
    ...
    if (mysqli_query($connection, $query)) {
        ...
        $message = '<div class="alert alert-danger">Error saving tank: ' . mysqli_error($connection) . '</div>';
    }
}
...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<title>PPMS Add Tank</title>
	</head>
	<body>
        <?php include('../include/navbar.php');?>
		<main class="main">
			<div class="container pt-4 pb-4">
				<form action="add-tank.php" method="POST">
					<h4 class="mb-5">Add Tank</h4>
                    <?php echo $message; ?>
					<div class="card mb-5">
						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group row">
										...
										<div class="col-lg-8 col-md-7 col-sm-8">
											<input type="text" name="tank_name" class="form-control" placeholder="e.g. Tank A" required>
										</div>
									</div>
									<div class="form-group row">
					...
					<div class="txt-center">
						<button type="submit" class="btn btn-primary m-top">Save Tank</button>
